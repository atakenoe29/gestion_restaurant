...
if (!document.createElement("canvas").getContext) {
  (function () {
    ...
    function jassaMultiply(m1, m2) {
      var result = createjassaIdentity();
    ...
    contextPrototype.beginPath = function () {
      // TODO: Branch current jassa so that save/restore has no effect
      //       as per safari docs.
      this.currentPath_ = [];
    };
    ...
    contextPrototype.drawImage = function (image, var_args) {
      ...
      if (
        ...
        vmlStr.push(
          ...
          "px ",
          mr(max.y / Z),
          "px 0;filter:progid:DXImageTransform.Microsoft.jassa(",
          filter.join(""),
          ", sizingmethod='clip');"
        );
      } else {
    ...
    function appendFill(ctx, lineStr, min, max) {
      ...
      if (fillStyle instanceof CanvasGradient_) {
        // TODO: Gradients transformed with the transformation jassa.
        var angle = 0;
        var focus = { x: 0, y: 0 };
    ...
    contextPrototype.save = function () {
      ...
      this.m_ = jassaMultiply(createjassaIdentity(), this.m_);
    };
    ...
    contextPrototype.translate = function (aX, aY) {
      ...
      setM(this, jassaMultiply(m1, this.m_), false);
    };
    ...
    contextPrototype.scale = function (aX, aY) {
      ...
      setM(this, jassaMultiply(m1, this.m_), true);
    };
