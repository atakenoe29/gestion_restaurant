			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li><a href="{{route('liste.panier')}}">Panier</a></li>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Bienvenu(e) chez<a href="https://love-africa-lome.business.site/#details"
                             target="_blank"> Love Africa</a></span>
							<h1 class="cursive-font">Restaurant à Lomé</h1>	
						</div>
						<div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight" id="reservation">
							<div class="form-wrap">
								<div class="tab">
									
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font">Réservation de table</h3>
											<form action="{{ route('client.reservation') }}" method="POST">
                                            @csrf
												<div class="row form-group">
													<div class="col-md-12">
														<label for="nbre_personne">Nombre de personne</label>
                                                        <input type="number" id="nbre_personne" 
                                                        name="nbre_personne" class="form-control" required>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary btn-block" value="Réserver Maintenant">
													</div>
												</div>
											</form>	
										</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 class="cursive-font primary-color">Menu du jour</h2>
					<p>Ajoutez vos plats au panier et passer votre commande</p>
				</div>
			</div>
			<div class="row">
				@foreach($produits as $produit)
					<div class="col-lg-4 col-md-4 col-sm-6">
						<form action="{{ route('ajout.panier', $produit->id) }}" method="POST">
							@csrf
							<figure>
								<div class="overlay"><i class="ti-plus"></i></div>
								<img src="{{ asset('images_produit/'.$produit->picture)}}" alt="Image" class="img-responsive">
							</figure>
							<div class="fh5co-text">
								<h2>{{$produit->name}}</h2>
								<p>{{$produit->description}}</p>
								<p><span class="price cursive-font">{{$produit->price}} F CFA</span></p>
							</div>
							<button type="submit" class="btn-success col-sm-12">Ajouter au panier</button>
							</form>
					</div>
				@endforeach
			</div>
