...
<html lang="en">
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" href="{{ asset('cover/css/bootstrap.min.css') }}">
      <!-- style css -->
      <link rel="stylesheet" href="{{ asset('cover/css/style.css') }}">
      <!-- Responsive-->
      <link rel="stylesheet" href="{{ asset('cover/css/responsive.css') }}">
      <!-- fevicon -->
      <link rel="icon" href="{{ asset('cover/images/fevicon.png') }}" type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="{{ asset('cover/css/jquery.mCustomScrollbar.min.css') }}">
      <link rel="stylesheet" href="{{ asset('cover/css/owl.carousel.min.css') }}">
   ...
   <body class="main-layout">
      <!-- loader  -->
      <div class="loader_bg">
         <div class="loader"><img src="{{ asset('cover/images/love_africa.jpg') }}" alt="#"/></div>
      </div>
      <!-- end loader -->
      <!-- header -->
      <div class="header">
               ...
               <div class="col-xl-1 col-lg-3 col-sm-2 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo">
                           <a href="index.html">Love Africa</a>
                        </div>
                     </div>
                  </div>
               </div>
                           ...
                           <div class="carousel-item active">
                              <div class="carousel-caption relative">
                                 <div class="row d_flex">
                                    <div class="col-md-5">
                                       <div class="zon_text">
                                          ...
                                          <p data-animation="animated bounceInLeft">
                                             Bienvenu(e) sur le site qui vous facilite la vie. Connectez vous selon votre profil.
                                          </p>
                                            @if (Route::has('login'))
                                                @auth
                                                ...
                                                @else
                                                    <button class="btn btn-primary  read_more bounceInLeft" data-animation="animated bounceInLeft">
                                                      <a href="{{ route('login') }}" style="color:white">Administrateur</a>
                                                   </button>
                                                    <button class="btn btn-primary  read_more bounceInLeft" data-animation="animated bounceInLeft">
                                                      <a href="{{ route('client.panel') }}" style="color:white">Client</a>
                                                   </button>
                                                @endauth
                                            @endif
                                       </div>
                                    ...
                                    <div class="col-md-7">
                                       <div class="coff_img">
                                          <figure><img src="{{ asset('cover/images/love_africa.jpg') }}" alt="#"/></figure>
                                       </div>
                                    </div>
                                 </div>
                              </div>
      ...
      <!-- end footer -->
      <!-- Javascript files-->
      <script src="{{ asset('cover/js/jquery.min.js') }}"></script>
      <script src="{{ asset('cover/js/bootstrap.bundle.min.js') }}"></script>
      <script src="{{ asset('cover/js/jquery-3.0.0.min.js') }}"></script>
      <!-- sidebar -->
      <script src="{{ asset('cover/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
      <script src="https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.8.1/baguetteBox.min.js"></script>
      <script src="{{ asset('cover/js/owl.carousel.min.js') }}"></script>
      <script src="{{ asset('cover/js/custom.js') }}"></script>
   </body>
</html>